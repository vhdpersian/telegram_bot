...
public class ReplyKeyboardMarkup implements CustomReplyKeyboard{
	...
	public void setKeyboard(final ArrayList<String[]> al) {
		this.keyboard = al;
	}
 ...
 */
	...
	public int hashCode() {
		 ...
		 */
		int result = 1;
		result = prime * result + Arrays.hashCode(keyboard.toArray());
		result = prime * result
	...
	public boolean equals(Object obj) {
		...
		if (!Arrays.deepEquals(keyboard.toArray(), other.keyboard.toArray()))
			return false;
